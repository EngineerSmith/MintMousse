...
return function(path, directoryPath)
  ...
  love.mintmousse = {
    ...
    THREAD_COMPONENT_UPDATES_ID = "MintMouseUpdate_", -- id for love.thread Channel (appended with threadID)
  }
  ...
  if not love.isThread then
    love.thread.getChannel(love.mintmousse.COMPONENT_TREE_VERSION_ID):push(0)
