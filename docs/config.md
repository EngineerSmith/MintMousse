...
**Type**: _table_(array of strings)<br>**Default**: `{ DIRECTORY_PATH .. "components/" }`
...
**Type**: _string_<br>**Default**: `DIRECTORY_PATH .. "thread/index.html"`
...
**Type**: _string_<br>**Default**: `DIRECTORY_PATH .. "thread/index.js"`
...
**Type**: _string_<br>**Default**: `DIRECTORY_PATH .. "thread/index.css"`
...
**Type**: _string_<br>**Default**: `"%Y-%m-%d %H:%M:%S.%f"`
...
**Type**: _boolean_<br>**Default**: `false`
...
**Type**: _number_<br>**Default**: `2^20` (1MB)
